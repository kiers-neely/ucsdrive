...
static const _RideRequest_type_support_symbol_names_t _RideRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_input_interfaces, msg, RideRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, user_input_interfaces, msg, RideRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, user_input_interfaces, msg, RideRequest)() {
  return &::user_input_interfaces::msg::rosidl_typesupport_c::RideRequest_message_type_support_handle;
}
