...
static const _RideMatch_type_support_symbol_names_t _RideMatch_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, user_input_interfaces, msg, RideMatch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, user_input_interfaces, msg, RideMatch)),
  }
};
...
{
  return &::user_input_interfaces::msg::rosidl_typesupport_cpp::RideMatch_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, user_input_interfaces, msg, RideMatch)() {
  return get_message_type_support_handle<user_input_interfaces::msg::RideMatch>();
}
